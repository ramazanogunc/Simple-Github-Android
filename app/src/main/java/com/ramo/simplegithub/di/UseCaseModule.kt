...
object UseCaseModule {
    ...
    @Singleton
    @Provides
    fun providesUserChangeFavoriteStatusUseCase(userRepository: UserRepository): UserChangeFavoriteStatusUseCase =
        UserChangeFavoriteStatusUseCase(userRepository)
